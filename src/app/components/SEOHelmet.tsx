...
export const SEOConfig = {
  home: {
    title: 'Кофе Нечай — обжарщики specialty кофе, доставка по России',
    ...
    keywords: 'кофе нечай, нечай кофе, nechai coffee, кофе нечай спб, coffeenechai.ru, кофе в зернах, свежая обжарка, спешелти кофе, specialty coffee, обжарка кофе петербург, купить кофе нечай, кофе доставка россия',
    rawTitle: true,
  },
  catalog: {
